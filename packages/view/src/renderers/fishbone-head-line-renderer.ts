 ...
 *
 * 参考旧系统 FishboneHeadLineRenderWorker：
 * - 显示鱼骨图的头线
 */
export class FishboneHeadLineRenderer implements Renderer {
  ...
  create(parent: Group): void {
    this.group = new Group({ name: 'fishbone-head-line-group' })
    this.line = new Path({ name: 'fishbone-head-line', fill: 'none' })
